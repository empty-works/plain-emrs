...
CREATE TABLE IF NOT EXISTS `plain_emrs`.`patient` (
  ...
  INDEX `fk_patient_user_account1_idx` (`user_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `plain_emrs`.`medical_record` (
  ...
  INDEX `fk_medical_records_patient1_idx` (`patient_id` ASC) VISIBLE,
  CONSTRAINT `fk_medical_records_patient1`
...
-- -----------------------------------------------------
-- Table `plain_emrs`.`users_role`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `plain_emrs`.`users_role` ;

CREATE TABLE IF NOT EXISTS `plain_emrs`.`users_role` (
  `user_id` INT NOT NULL,
