...
START TRANSACTION;
USE `plain_emrs`;
INSERT INTO `plain_emrs`.`people` (`person_id`, `given_name`, `middle_name`, `last_name`, `street_address`, `city`, `state`, `country`, `phone_number`, `date_of_birth`) VALUES (0, 'The', 'Cool', 'Admin', '1 Admin Ave.', 'City', 'State', 'Country', '999-999', '1993-01-23');
...
START TRANSACTION;
USE `plain_emrs`;
INSERT INTO `plain_emrs`.`users` (`person_id`, `username`, `password`, `email_address`, `created_on`, `enabled`) VALUES (0, 'the_admin', '{bcrypt}$2y$12$b26SIauLyCvVN.Z9JreAdusKSlIvpBaDrWbkbW/xjyBgPRBVOpiYW ', 'the_admin@gmail.com', '2021-04-04', 1);
...
START TRANSACTION;
USE `plain_emrs`;
INSERT INTO `plain_emrs`.`authorities` (`authority`, `person_id`, `username`) VALUES ('ADMIN', 0, 'the_admin');
