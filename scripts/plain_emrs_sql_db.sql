...
START TRANSACTION;
USE `plain_emrs`;
INSERT INTO `plain_emrs`.`users` (`username`, `password`, `email_address`, `created_on`, `enabled`, `person_id`) VALUES ('the_admin_12345', '{bcrypth}$2y$10$hbNzauLxTmfmqh10.QvCOekFz5bsDYy9SRqcmb4Y8Wrw46NZ5CRX6', 'the_admin@gmail.com', '2021-04-04', 1, 0);
