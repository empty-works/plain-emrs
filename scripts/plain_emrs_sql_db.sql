...
CREATE TABLE IF NOT EXISTS `plain_emrs`.`diagnosis` (
  ...
  CONSTRAINT `fk_diagnosis_medical_record1`
    FOREIGN KEY (`record_id` , `person_patient_id`)
    REFERENCES `plain_emrs`.`medical_record` (`record_id` , `person_patient_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `plain_emrs`.`access_log` (
  ...
  PRIMARY KEY (`user_user_id`, `user_person_id`),
  CONSTRAINT `fk_access_log_user1`
    FOREIGN KEY (`user_user_id` , `user_person_id`)
    REFERENCES `plain_emrs`.`user` (`user_id` , `person_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `plain_emrs`.`user_role` (
  ...
  INDEX `fk_user_role_user1_idx` (`user_id` ASC, `person_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `plain_emrs`.`patient_doctor`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `plain_emrs`.`patient_doctor` ;

CREATE TABLE IF NOT EXISTS `plain_emrs`.`patient_doctor` (
  `record_id` INT UNSIGNED NOT NULL,
  `person_patient_id` INT NOT NULL,
  `person_staff_id` INT NULL,
  PRIMARY KEY (`record_id`, `person_patient_id`),
  CONSTRAINT `fk_patient_doctor_medical_record1`
    FOREIGN KEY (`record_id` , `person_patient_id`)
    REFERENCES `plain_emrs`.`medical_record` (`record_id` , `person_patient_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `plain_emrs`.`person_staff_doctor` (
  ...
  `person_staff_person_staff_id` INT NOT NULL,
  PRIMARY KEY (`person_staff_person_staff_id`),
  CONSTRAINT `fk_person_staff_doctor_person_staff1`
    FOREIGN KEY (`person_staff_person_staff_id`)
...
CREATE TABLE IF NOT EXISTS `plain_emrs`.`person_staff_position` (
  `person_staff_id` INT NOT NULL,
  `staff_position_id` INT NOT NULL,
  PRIMARY KEY (`person_staff_id`, `staff_position_id`),
