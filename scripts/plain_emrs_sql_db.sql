...
START TRANSACTION;
USE `plain_emrs`;
INSERT INTO `plain_emrs`.`users` (`user_id`, `username`, `password`, `email_address`, `created_on`, `enabled`, `person_id`) VALUES (0, 'the_admin', '{noop}123', 'the_admin@gmail.com', '2021-04-04', 1, 0);
...
START TRANSACTION;
USE `plain_emrs`;
INSERT INTO `plain_emrs`.`authorities` (`authority`, `user_id`) VALUES ('ROLE_ADMIN', 0);
